odoo.define('subscription_subscription.tour', function(require) {
"use_strict";
...
tour.register('subscription_subscription_tour', {
    url: "/web",
    sequence: 250,
}, [{
    trigger: '.o_app[data-menu-xmlid="subscription_subscription.menu_subscription_subscription_root"]',
	content: _t('Want recurring billing via subscription management ? Get started by clicking here'),
    position: 'bottom',
},
{
    trigger: '.dropdown-toggle[data-menu-xmlid="subscription_subscription.menu_subscription_subscription_config"]',
    content: _t('Configure your subscription templates here'),
    position: 'bottom',},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="subscription_subscription.menu_template_of_subscription"]',
...
{
    trigger: '.dropdown-toggle[data-menu-xmlid="subscription_subscription.menu_subscription_subscription"]',
    content: _t('Let\'s go to the catalog to create our first subscription product'),
    position: 'bottom',
},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="subscription_subscription.menu_subscription_subscription_product"]',
